...
def grouping(test_array):
        ...
        for j in range(len(test_array[0])):
            ...
            if first == 0:
                ...
                if test_array[i,j] > (avg - (alpha*var)) and test_array[i,j] <= (avg + (alpha*var)):
                    ...
                    region[k] = test_array[i,j] #variable to track total volume of given group
    ...
    if max_point == 20:
        x_coord = (max_point*64) - (64/2)
    else: 
        x_coord = ((max_point + 1)*64 - (64/2))
...
def PPX_Interp(): #Node for reading PPX file and outputing desired coordinate
    ...
    while not rospy.is_shutdown():
        ...
        with open('/home/curran/Documents/rost_ws/rost-cli-master/build/perplexity.json', "r") as f:
